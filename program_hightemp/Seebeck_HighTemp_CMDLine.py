...
class Main:
            ...
            while True:
                ...
                if (self.tol == 'OK' and self.stable == 'OK'):
                    for self.dT in self.dTList:
                        print "Set delta temp to %f" %(self.dT)
    ...
    def Get_User_Input(self):
        ...
        self.measureList = input("Please enter the self.temperatures to measure as a list (example: [25, 50, ...]): ")
    ...
    def safety_check(self):
        print 'safety check'
        if self.sampletempA or self.sampletempA2 > 600:
            self.abort_ID = 1
            print 'Safety Failure: Sample Temp A greater than 600'
        #end if
        if self.sampletempB or self.sampletempA2 > 600:
            self.abort_ID = 1
        ...
        #end if
        if self.blocktempA > self.sampletempA + 100 or self.sampletempA2 + 100:
            self.abort_ID = 1
            print 'Safety Failure: Block Temp A  100 C greater than Sample Temp A'
        #end if
        if self.blocktempB > self.sampletempB + 100 or self.sampletempB2 + 100:
            self.abort_ID = 1
            print 'Safety Failure: Block Temp B  100 C greater than Sample Temp B'
        #end if
        if self.sampletempA  or self.sampletempA2 > self.blocktempA + 100:
            self.abort_ID = 1
            print 'Safety Failure: Sample Temp A  100 C greater than Block Temp A'
        #end if
        if self.sampletempB  or self.sampletempB2 > self.blocktempB + 100:
            self.abort_ID = 1
