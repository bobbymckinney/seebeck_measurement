...
equil_tolerance = 2 # PID temp must not change by this value for a set time in order to reach an equilibrium
equil_time = 30 # How many measurements until the PID will change after reaching an equilibrium point
...
class Setup:
    ...
    def __init__(self):
        ...
        self.k2700.ctrl.write(":SENSe1:VOLTage:DC:NPLCycles 2, (@ 107,108)") # Sets integration period based on frequency
        self.k2700.ctrl.write(":SENSe1:TEMPerature:NPLCycles 2, (@ 109,110)")
...
class TakeData:
    ...
    def check_status(self):
        ...
        if (self.pidA < self.pidAset + equil_tolerance and self.pidA > self.pidAset - equil_tolerance and self.pidB < self.pidBset + equil_tolerance and self.pidB > self.pidBset - equil_tolerance ):
            equil = 'OK'
        #end if
    ...
    def start_equil_timer(self):
        ...
        self.time_left = int(equil_time*5 - time_passed)
...
class StatusPanel(wx.Panel):
    ...
    def create_status(self):
        ...
        self.label_pAset = wx.StaticText(self, label="pid A setpoint (C):")
        self.label_pAset.SetFont(wx.Font(16, wx.DEFAULT, wx.NORMAL, wx.NORMAL))
        self.label_pBset = wx.StaticText(self, label="pid B setpoint (C):")
    ...
    def create_sizer(self):    
        ...
        sizer.Add(self.label_pA, (6,0))
        sizer.Add(self.pAcurrent, (6,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
        sizer.Add(self.label_pAset, (7,0))
        sizer.Add(self.pAsetcurrent, (7,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
        
        sizer.Add(self.label_tB, (8,0))
        sizer.Add(self.tBcurrent, (8,1),flag=wx.ALIGN_CENTER_HORIZONTAL)
...
class App(wx.App):
    ...
    #--------------------------------------------------------------------------
    def OnInit(self):
        self.frame = Frame(parent=None, title="Voltage Panel", size=(1280,1280))
        self.frame.Show()
