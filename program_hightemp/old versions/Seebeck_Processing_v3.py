...
class Process_Data:
    ...
    def __init__(self, directory, fileName, tc_type):
        ...
        filePath = directory + '/Raw Data/' + fileName
    ...
    def create_plot(self, x, ylow, yhigh, fitLow, fitHigh, title):
        ...
        # Save:
        processed_data_folder = self.directory + '/Processed Data/'
        if not os.path.exists(processed_data_folder):
            os.makedirs(processed_data_folder)
        plot_folder = processed_data_folder + 'Plots/'
...
def extract_Data(filePath):
    ...
    print('Successfully slit each line of data')
...
def create_processed_files(directory, fileName, tc_type):
    ...
    # Make a new folder:
    processed_data_folder = directory + '/Processed Data/'
    if not os.path.exists(processed_data_folder):
        os.makedirs(processed_data_folder)
    ...
    outFile = processed_data_folder + 'Processed_Data.csv'
    ...
    seebeck_file = processed_data_folder + 'Seebeck_Data.csv'
    file = seebeck_file
